...
namespace CHUNGCUVINHOME {
    ...
    public partial class dtsNhanVien : global::System.Data.DataSet {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MANV, string HOTENNV, System.DateTime NS, string PHAI, string CHUCVU, string MAIL) {
...
namespace CHUNGCUVINHOME.dtsNhanVienTableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [NHANVIEN] WHERE (([MANV] = @Original_MANV) AND ((@IsNull_HOTENNV = 1 AND [HOTENNV] IS NULL) OR ([HOTENNV] = @Original_HOTENNV)) AND ((@IsNull_NS = 1 AND [NS] IS NULL) OR ([NS] = @Original_NS)) AND ((@IsNull_PHAI = 1 AND [PHAI] IS NULL) OR ([PHAI] = @Original_PHAI)) AND ((@IsNull_CHUCVU = 1 AND [CHUCVU] IS NULL) OR ([CHUCVU] = @Original_CHUCVU)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [NHANVIEN] ([MANV], [HOTENNV], [NS], [PHAI], [CHUCVU], [MAIL]) VALUES" +
                " (@MANV, @HOTENNV, @NS, @PHAI, @CHUCVU, @MAIL);\r\nSELECT MANV, HOTENNV, NS, PHAI," +
                " CHUCVU, MAIL FROM NHANVIEN WHERE (MANV = @MANV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [NHANVIEN] SET [MANV] = @MANV, [HOTENNV] = @HOTENNV, [NS] = @NS, [PHAI] = @PHAI, [CHUCVU] = @CHUCVU, [MAIL] = @MAIL WHERE (([MANV] = @Original_MANV) AND ((@IsNull_HOTENNV = 1 AND [HOTENNV] IS NULL) OR ([HOTENNV] = @Original_HOTENNV)) AND ((@IsNull_NS = 1 AND [NS] IS NULL) OR ([NS] = @Original_NS)) AND ((@IsNull_PHAI = 1 AND [PHAI] IS NULL) OR ([PHAI] = @Original_PHAI)) AND ((@IsNull_CHUCVU = 1 AND [CHUCVU] IS NULL) OR ([CHUCVU] = @Original_CHUCVU)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)));
SELECT MANV, HOTENNV, NS, PHAI, CHUCVU, MAIL FROM NHANVIEN WHERE (MANV = @MANV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        MANV, HOTENNV, NS, PHAI, CHUCVU, MAIL\r\nFROM            NHANVIEN";
        ...
        public virtual int Delete(string Original_MANV, string Original_HOTENNV, global::System.Nullable<global::System.DateTime> Original_NS, string Original_PHAI, string Original_CHUCVU, string Original_MAIL) {
        ...
        public virtual int Insert(string MANV, string HOTENNV, global::System.Nullable<global::System.DateTime> NS, string PHAI, string CHUCVU, string MAIL) {
            if ((MANV == null)) {
        ...
        public virtual int Update(string MANV, string HOTENNV, global::System.Nullable<global::System.DateTime> NS, string PHAI, string CHUCVU, string MAIL, string Original_MANV, string Original_HOTENNV, global::System.Nullable<global::System.DateTime> Original_NS, string Original_PHAI, string Original_CHUCVU, string Original_MAIL) {
            if ((MANV == null)) {
                throw new global::System.ArgumentNullException("MANV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HOTENNV, global::System.Nullable<global::System.DateTime> NS, string PHAI, string CHUCVU, string MAIL, string Original_MANV, string Original_HOTENNV, global::System.Nullable<global::System.DateTime> Original_NS, string Original_PHAI, string Original_CHUCVU, string Original_MAIL) {
            return this.Update(Original_MANV, HOTENNV, NS, PHAI, CHUCVU, MAIL, Original_MANV, Original_HOTENNV, Original_NS, Original_PHAI, Original_CHUCVU, Original_MAIL);
        }
    }
